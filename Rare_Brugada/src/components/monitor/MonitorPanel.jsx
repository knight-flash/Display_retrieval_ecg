        ...
        <div className="col-span-7 flex flex-col h-full min-h-0 gap-3">
            ...
            <div className="flex-1 bg-white rounded-xl shadow-sm border border-slate-200 relative flex flex-col overflow-hidden">
                ...
                <div className="flex-1 relative overflow-hidden">
                    {/* 
                      Force absolute positioning to ensure the canvas container strictly follows 
                      the parent dimensions and doesn't get pushed out by child content flow.
                      This is critical for the internal scrollbar to work correctly.
                     */}
