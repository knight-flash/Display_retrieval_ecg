...
// Globals
const manifestModules = import.meta.glob('./data/database/manifest.json');
const caseModules = import.meta.glob('./data/database/cases/*.json');
const retrievalModules = import.meta.glob('./data/database/retrievals/*.json');
...
function App() {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      try {
        // Load Query Case
        const casePath = `./data/database/${currentTask.fileName}`;
        // Find matching key
